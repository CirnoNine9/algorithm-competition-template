...
const printPageNumbers = {
  ...
  documents: {
    ...
    '05-多项式/12-多项式加法减法.md': 62,
    '05-多项式/13-多项式整除与取模.md': 63,
    '05-多项式/14-多项式对数与指数.md': 64,
    '05-多项式/15-多项式平方根.md': 66,
    '05-多项式/16-多项式快速幂.md': 67,
    '05-多项式/17-拉格朗日反演.md': 68,
    '05-多项式/18-单位根反演.md': 69,
    '05-多项式/19-分式第N项.md': 70,
    '05-多项式/20-多点求值.md': 71,
    '05-多项式/21-点值平移.md': 73,
    '05-多项式/22-快速阶乘.md': 74,
    '05-多项式/23-Power-Projection-基础版.md': 75,
    '05-多项式/24-Power-Projection-卡常版.md': 76,
    '05-多项式/25-最短递推式.md': 79,
    '06-Python/01-datetime库.md': 81,
    '06-Python/02-Fraction库.md': 83,
    '06-Python/03-math库常用函数.md': 85,
  } as Record<string, number>,
};
