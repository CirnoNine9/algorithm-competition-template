...
const printPageNumbers = {
  ...
  documents: {
    ...
    '04-图论与网络流/01-Dinic最大流.md': 57,
    '04-图论与网络流/02-HLPP最大流.md': 59,
    '04-图论与网络流/03-有上下界流.md': 62,
    '04-图论与网络流/04-最小费用流.md': 64,
    '04-图论与网络流/05-有上下界最小费用流.md': 67,
    '04-图论与网络流/06-强连通分量.md': 69,
    '04-图论与网络流/07-边双连通分量.md': 71,
    '04-图论与网络流/08-点双连通分量.md': 73,
    '04-图论与网络流/09-2-SAT.md': 75,
    '05-多项式/01-拉格朗日插值.md': 78,
    '05-多项式/02-FFT.md': 79,
    '05-多项式/03-NTT-基础版.md': 80,
    '05-多项式/04-NTT-卡常版.md': 81,
    '05-多项式/05-MTT任意模卷积.md': 84,
    '05-多项式/06-二元NTT.md': 85,
    '05-多项式/07-二元多项式卷积.md': 86,
    '05-多项式/08-任意因子长度DFT.md': 87,
    '05-多项式/09-FWT.md': 89,
    '05-多项式/10-多项式乘法逆.md': 91,
    '05-多项式/11-稀疏多项式除法.md': 92,
    '05-多项式/12-多项式加法减法.md': 93,
    '05-多项式/13-多项式整除与取模.md': 94,
    '05-多项式/14-多项式对数与指数.md': 95,
    '05-多项式/15-多项式平方根.md': 97,
    '05-多项式/16-多项式快速幂.md': 98,
    '05-多项式/17-拉格朗日反演.md': 99,
    '05-多项式/18-单位根反演.md': 100,
    '05-多项式/19-分式第N项.md': 101,
    '05-多项式/20-多点求值.md': 102,
    '05-多项式/21-点值平移.md': 104,
    '05-多项式/22-快速阶乘.md': 105,
    '05-多项式/23-Power-Projection-基础版.md': 106,
    '05-多项式/24-Power-Projection-卡常版.md': 107,
    '05-多项式/25-最短递推式.md': 110,
    '05-多项式/26-常系数齐次线性递推.md': 112,
    '06-杂项/01-i128重载.md': 114,
    '06-杂项/02-datetime库.md': 116,
    '06-杂项/03-Fraction库.md': 118,
    '06-杂项/04-math库常用函数.md': 120,
  } as Record<string, number>,
  sections: {
