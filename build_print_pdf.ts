...
const printPageNumbers = {
  ...
  documents: {
    ...
    '05-多项式/01-拉格朗日插值.md': 68,
    '05-多项式/02-FFT.md': 69,
    '05-多项式/03-NTT-基础版.md': 70,
    '05-多项式/04-NTT-卡常版.md': 71,
    '05-多项式/05-MTT任意模卷积.md': 74,
    '05-多项式/06-二元NTT.md': 75,
    '05-多项式/07-二元多项式卷积.md': 76,
    '05-多项式/08-任意因子长度DFT.md': 77,
    '05-多项式/09-FWT.md': 79,
    '05-多项式/10-多项式乘法逆.md': 81,
    '05-多项式/11-稀疏多项式除法.md': 82,
    '05-多项式/12-多项式加法减法.md': 83,
    '05-多项式/13-多项式整除与取模.md': 84,
    '05-多项式/14-多项式对数与指数.md': 85,
    '05-多项式/15-多项式平方根.md': 87,
    '05-多项式/16-多项式快速幂.md': 88,
    '05-多项式/17-拉格朗日反演.md': 89,
    '05-多项式/18-单位根反演.md': 90,
    '05-多项式/19-分式第N项.md': 91,
    '05-多项式/20-多点求值.md': 92,
    '05-多项式/21-点值平移.md': 94,
    '05-多项式/22-快速阶乘.md': 95,
    '05-多项式/23-Power-Projection-基础版.md': 96,
    '05-多项式/24-Power-Projection-卡常版.md': 97,
    '05-多项式/25-最短递推式.md': 100,
    '05-多项式/26-常系数齐次线性递推.md': 102,
    '06-Python/01-datetime库.md': 104,
    '06-Python/02-Fraction库.md': 106,
    '06-Python/03-math库常用函数.md': 108,
  } as Record<string, number>,
  sections: {
