...
const printPageNumbers = {
  ...
  documents: {
    ...
    '02-计算几何/05-半平面交.md': 32,
    '03-数据结构/01-树状数组.md': 34,
    '03-数据结构/02-线段树-区间取min.md': 35,
    '03-数据结构/03-Treap.md': 37,
    '03-数据结构/04-pb_ds平衡树.md': 40,
    '03-数据结构/05-Link-Cut-Tree.md': 41,
    '04-图论与网络流/01-Dinic最大流.md': 45,
    '04-图论与网络流/02-HLPP最大流.md': 47,
    '05-多项式/01-拉格朗日插值.md': 51,
    '05-多项式/02-FFT.md': 52,
    '05-多项式/03-NTT-基础版.md': 53,
    '05-多项式/04-NTT-卡常版.md': 54,
    '05-多项式/05-MTT任意模卷积.md': 57,
    '05-多项式/06-二元NTT.md': 58,
    '05-多项式/07-二元多项式卷积.md': 59,
    '05-多项式/08-任意因子长度DFT.md': 60,
    '05-多项式/09-FWT.md': 62,
    '05-多项式/10-多项式乘法逆.md': 64,
    '05-多项式/11-稀疏多项式除法.md': 65,
    '05-多项式/12-多项式加法减法.md': 66,
    '05-多项式/13-多项式整除与取模.md': 67,
    '05-多项式/14-多项式对数与指数.md': 68,
    '05-多项式/15-多项式平方根.md': 70,
    '05-多项式/16-多项式快速幂.md': 71,
    '05-多项式/17-拉格朗日反演.md': 72,
    '05-多项式/18-单位根反演.md': 73,
    '05-多项式/19-分式第N项.md': 74,
    '05-多项式/20-多点求值.md': 75,
    '05-多项式/21-点值平移.md': 77,
    '05-多项式/22-快速阶乘.md': 78,
    '05-多项式/23-Power-Projection-基础版.md': 79,
    '05-多项式/24-Power-Projection-卡常版.md': 80,
    '05-多项式/25-最短递推式.md': 83,
    '05-多项式/26-常系数齐次线性递推.md': 85,
    '06-Python/01-datetime库.md': 87,
    '06-Python/02-Fraction库.md': 89,
    '06-Python/03-math库常用函数.md': 91,
  } as Record<string, number>,
};
