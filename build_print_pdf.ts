...
const printPageNumbers = {
  ...
  documents: {
    ...
    '03-数据结构/02-线段树.md': 40,
    '03-数据结构/03-Treap.md': 43,
    '03-数据结构/04-pb_ds平衡树.md': 47,
    '03-数据结构/05-pb_ds配对堆.md': 48,
    '03-数据结构/06-树链剖分.md': 49,
    '03-数据结构/07-Link-Cut-Tree.md': 51,
    '03-数据结构/08-后缀自动机.md': 54,
    '04-图论与网络流/01-强连通分量.md': 57,
    '04-图论与网络流/02-边双连通分量.md': 59,
    '04-图论与网络流/03-点双连通分量.md': 61,
    '04-图论与网络流/04-2-SAT.md': 63,
    '04-图论与网络流/05-Dinic最大流.md': 65,
    '04-图论与网络流/06-HLPP最大流.md': 67,
    '04-图论与网络流/07-有上下界流.md': 70,
    '04-图论与网络流/08-最小费用流.md': 72,
    '04-图论与网络流/09-有上下界最小费用流.md': 75,
    '04-图论与网络流/10-二分图最大权匹配.md': 77,
    '04-图论与网络流/11-图匹配相关性质.md': 79,
    '05-多项式/01-拉格朗日插值.md': 82,
    '05-多项式/02-FFT.md': 83,
    '05-多项式/03-NTT-基础版.md': 84,
    '05-多项式/04-NTT-卡常版.md': 85,
    '05-多项式/05-MTT任意模卷积.md': 88,
    '05-多项式/06-二元NTT.md': 89,
    '05-多项式/07-二元多项式卷积.md': 90,
    '05-多项式/08-任意因子长度DFT.md': 91,
    '05-多项式/09-FWT.md': 93,
    '05-多项式/10-多项式乘法逆.md': 95,
    '05-多项式/11-稀疏多项式除法.md': 96,
    '05-多项式/12-多项式加法减法.md': 97,
    '05-多项式/13-多项式整除与取模.md': 98,
    '05-多项式/14-多项式对数与指数.md': 99,
    '05-多项式/15-多项式平方根.md': 101,
    '05-多项式/16-多项式快速幂.md': 102,
    '05-多项式/17-拉格朗日反演.md': 103,
    '05-多项式/18-单位根反演.md': 104,
    '05-多项式/19-分式第N项.md': 105,
    '05-多项式/20-多点求值.md': 106,
    '05-多项式/21-点值平移.md': 108,
    '05-多项式/22-快速阶乘.md': 109,
    '05-多项式/23-Power-Projection-基础版.md': 110,
    '05-多项式/24-Power-Projection-卡常版.md': 111,
    '05-多项式/25-最短递推式.md': 114,
    '05-多项式/26-常系数齐次线性递推.md': 116,
    '06-杂项/01-i128重载.md': 118,
    '06-杂项/02-datetime库.md': 120,
    '06-杂项/03-Fraction库.md': 122,
    '06-杂项/04-math库常用函数.md': 124,
  } as Record<string, number>,
  sections: {
