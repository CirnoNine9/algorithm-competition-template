...
async function main(): Promise<void> {
  ...
  if (documents.length !== 65) throw new Error(`Expected 65 template documents, found ${documents.length}.`);
  ...
  if (htmlFiles.length !== 73) {
    throw new Error(`Expected 73 HTML pages, generated ${htmlFiles.length}.`);
  }
