...
async function main(): Promise<void> {
  ...
  if (documents.length !== 56) throw new Error(`Expected 56 template documents, found ${documents.length}.`);
  ...
  if (htmlFiles.length !== 64) {
    throw new Error(`Expected 64 HTML pages, generated ${htmlFiles.length}.`);
  }
