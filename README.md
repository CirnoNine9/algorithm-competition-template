...
| [计算几何](模板/02-计算几何/README.md) | 7 | 点与凸包、直线、多边形、圆、半平面交、Delaunay 三角剖分 |
| [数据结构](模板/03-数据结构/README.md) | 9 | 树状数组、线段树、Treap、`pb_ds` 平衡树与配对堆、树链剖分、Link–Cut Tree、点分治、后缀自动机 |
| [图论与网络流](模板/04-图论与网络流/README.md) | 11 | 强连通分量、边双、点双、2-SAT、匹配与二分图性质、二分图最大权匹配、Dinic、HLPP、上下界流与费用流 |
| [多项式](模板/05-多项式/README.md) | 26 | FFT、NTT、FWT、形式幂级数、多点求值、线性递推等 |
| [杂项](模板/06-杂项/README.md) | 4 | `i128` 辅助与 Python 常用标准库接口 |
